...
function AboutWhoWeAre() {
  return (
    <section className="section-block bg-gradient-to-br from-primary/5 via-white to-emerald/5" aria-labelledby="about-who-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="absolute -inset-4 bg-gradient-to-br from-primary/20 via-secondary/15 to-emerald/15 rounded-3xl blur-2xl opacity-60" aria-hidden />
            <div className="relative bg-white rounded-3xl border border-text/10 p-8 lg:p-10 shadow-xl">
              <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100 border border-text/10 flex flex-col items-center justify-center p-8 text-center">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center text-white mb-6 shadow-lg">
