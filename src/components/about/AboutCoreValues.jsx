...
function AboutCoreValues() {
  return (
    <section className="section-block bg-gradient-to-b from-white to-background" aria-labelledby="about-core-values-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {coreValues.map((value) => (
            <article
              key={value.id}
              className="group rounded-2xl border border-text/10 bg-white p-6 shadow-sm hover:shadow-lg hover:-translate-y-0.5 hover:border-primary/25 transition-all duration-300"
            >
