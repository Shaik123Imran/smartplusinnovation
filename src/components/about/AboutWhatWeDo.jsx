      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {whatWeDo.pillars.map((pillar, index) => (
            <article
              key={pillar.id}
              className="relative flex flex-col rounded-2xl border border-text/10 bg-background/50 p-8 shadow-sm hover:shadow-lg hover:border-primary/20 transition-all duration-300"
            >
              <div className="absolute top-8 right-8 text-5xl font-extrabold text-primary/10 select-none" aria-hidden>
