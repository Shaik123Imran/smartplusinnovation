      ...
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            >
              <span className="font-semibold text-neutral-900 text-sm sm:text-base">{item.title}</span>
              <span className="text-neutral-500 text-lg leading-none shrink-0">{isOpen ? '−' : '+'}</span>
            </button>
            <div
